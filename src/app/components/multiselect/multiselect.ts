    ...
    template: `
        <li
            ...
            [ngClass]="{
                ...
                'ui-state-disabled':
                    option.disabled || (maxSelectionLimitReached && !selected)
            }"
        >
...
@Component({
    ...
    template: `
        ...
        >
            ...
            <div
                [ngClass]="{
                    'ui-multiselect-trigger ui-state-default ui-corner-right': true
                }"
            >
                <span
            ...
            >
                <div
                    ...
                    [ngClass]="{
                        'ui-multiselect-header-no-toggleall': !showToggleAll
                    }"
                    *ngIf="showHeader"
                >
                    ...
                    >
                        ...
                        >
                            <span
                                class="ui-chkbox-icon ui-clickable"
                                [ngClass]="{ 'pi pi-check': isAllChecked() }"
                            ></span>
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        <ng-container
                            *ngIf="!virtualScroll; else virtualScrollList"
                        >
                            <ng-template
                                ngFor
                                let-option
...
export class MultiSelect
    ...
    updateFilledState() {
        this.filled =
            this.valuesAsString != null && this.valuesAsString.length > 0;
    }
    ...
    onOptionClick(event) {
        ...
        if (selectionIndex != -1) {
            ...
            if (
                !this.selectionLimit ||
                !this.value || this.value.length < this.selectionLimit
            ) {
    ...
    isAllChecked() {
        if (this.filterValue && this.filterValue.trim().length) {
            ...
            return (
                this.value &&
                this.options &&
                this.value.length > 0 && this.value.length == optionCount
            );
        }
    }
    ...
    activateFilter() {
        if (this.options && this.options.length) {
            ...
            this.visibleOptions = ObjectUtils.filter(
                this.options,
                searchFields,
                this.filterValue
            );
